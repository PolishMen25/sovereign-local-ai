...
exec "$runtime_dir/llama-cli" \
  ...
  --conversation \
  --simple-io \
  --system-prompt "Tu es BOOTSTRAP, un assistant local temporaire distinct de CORE-700M. Réponds en français, clairement et honnêtement. Tu n'as ni outil ni accès Internet. Ne prétends jamais être CORE." \
