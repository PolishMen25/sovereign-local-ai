...
| CORE-700M | Cinq étapes CPU et reprise réelle vérifiées | Configuration de 691 160 320 paramètres ; tokenizer 32k `candidate_core`, corpus anglais technique initial approuvé ; étape 1, reprise jusqu'à l'étape 2, puis palier contrôlé jusqu'à 5 avec checkpoints durables | Cinq étapes ne produisent pas un assistant ; aucun benchmark de débit/NUMA validé, aucune évaluation linguistique ni moteur de chat CORE |
