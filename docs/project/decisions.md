...
| D-006 | **SUPERSEDED par D-034.** Le DL380p Gen8 était exclu de la V1. | Conservé pour la traçabilité ; aucune fonction CORE ni aucun entraînement ne lui est toutefois confié. |
...
| D-026 | **SUPERSEDED par D-034.** `CORE-700M` remplaçait CORE-80M comme candidat principal. | La configuration et les preuves mécaniques restent conservées ; aucun entraînement long CORE-700M n'est poursuivi. |
| D-027 | **SUPERSEDED par D-032.** Les conversations et données personnelles restaient dans la mémoire/RAG jusqu'à suppression explicite et n'étaient jamais ajoutées automatiquement aux poids. | Conservé pour la traçabilité. |
